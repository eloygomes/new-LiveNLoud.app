...
var GroupOperation = /** @class */ (function (_super) {
    ...
    /**
     */
    GroupOperation.prototype.childrenNext = function (item, key, owner, REMOVED_MONGO_USER) {
        var done = true;
        var keep = true;
        for (var i = 0, length_3 = this.children.length; i < length_3; i++) {
            var childOperation = this.children[i];
            if (!childOperation.done) {
                childOperation.next(item, key, owner, REMOVED_MONGO_USER);
            }
...
var QueryOperation = /** @class */ (function (_super) {
    ...
    /**
     */
    QueryOperation.prototype.next = function (item, key, parent, REMOVED_MONGO_USER) {
        this.childrenNext(item, key, parent, REMOVED_MONGO_USER);
    };
...
var NestedOperation = /** @class */ (function (_super) {
    ...
    function NestedOperation(keyPath, params, owneryQuery, options, children) {
        ...
        /**
         */
        _this._nextNestedValue = function (value, key, owner, REMOVED_MONGO_USER) {
            _this.childrenNext(value, key, owner, REMOVED_MONGO_USER);
            return !_this.done;
        };
        return _this;
    }
...
var $Not = /** @class */ (function (_super) {
    ...
    $Not.prototype.next = function (item, key, owner, REMOVED_MONGO_USER) {
        this._queryOperation.next(item, key, owner, REMOVED_MONGO_USER);
...
var $Nin = /** @class */ (function (_super) {
    ...
    $Nin.prototype.next = function (item, key, owner, REMOVED_MONGO_USER) {
        this._in.next(item, key, owner);
        if (isArray(owner) && !REMOVED_MONGO_USER) {
            if (this._in.keep) {
                this.keep = false;
                this.done = true;
            }
...
var $And = /** @class */ (function (_super) {
    ...
    $And.prototype.next = function (item, key, owner, REMOVED_MONGO_USER) {
        this.childrenNext(item, key, owner, REMOVED_MONGO_USER);
    };
    return $And;
}(NamedGroupOperation));
var $All = /** @class */ (function (_super) {
    ...
    $All.prototype.next = function (item, key, owner, REMOVED_MONGO_USER) {
        this.childrenNext(item, key, owner, REMOVED_MONGO_USER);
    };
    return $All;
}(NamedGroupOperation));
