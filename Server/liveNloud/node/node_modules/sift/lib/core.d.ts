...
export interface Operation<TItem> {
    ...
    propop: boolean;
    reset(): any;
    next(item: TItem, key?: Key, owner?: any, REMOVED_MONGO_USER?: boolean): any;
}
export declare type Tester = (item: any, key?: Key, owner?: any, REMOVED_MONGO_USER?: boolean) => boolean;
...
export declare abstract class BaseOperation<TParams, TItem = any> implements Operation<TItem> {
    ...
    protected init(): void;
    reset(): void;
    abstract next(item: any, key: Key, parent: any, REMOVED_MONGO_USER: boolean): any;
}
declare abstract class GroupOperation extends BaseOperation<any> {
     ...
     */
    reset(): void;
    abstract next(item: any, key: Key, owner: any, REMOVED_MONGO_USER: boolean): any;
    /**
     */
    protected childrenNext(item: any, key: Key, owner: any, REMOVED_MONGO_USER: boolean): void;
}
...
export declare class QueryOperation<TItem> extends GroupOperation {
    ...
    /**
     */
    next(item: TItem, key: Key, parent: any, REMOVED_MONGO_USER: boolean): void;
}
