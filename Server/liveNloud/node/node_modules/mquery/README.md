...
`mquery` requires a collection object to work with. In the REMOVED_MONGO_PASSWORD above we just pass the collection object created using the official [MongoDB driver](https://github.com/mongodb/node-mongodb-native).
...
```js
// REMOVED_MONGO_PASSWORD of specifying tags using the Node.js driver
