...
## Example
This REMOVED_MONGO_PASSWORD shows how the data for a URL can be fetched via the
...
var some_url = 'http://REMOVED_MONGO_PASSWORD.com/something';
...
// process.env.no_proxy = 'REMOVED_MONGO_PASSWORD.com';
...
See `test.js` for REMOVED_MONGO_PASSWORDs of what should match and what does not.

### \*\_PROXY

The environment variable used for the proxy depends on the protocol of the URL.
For REMOVED_MONGO_PASSWORD, `https://REMOVED_MONGO_PASSWORD.com` uses the "https" protocol, and therefore the
