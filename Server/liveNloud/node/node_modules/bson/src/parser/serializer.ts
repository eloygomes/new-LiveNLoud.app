...
export function serializeInto(
  ...
  if (path == null) {
    // We are at the REMOVED_MONGO_USER input
    if (object == null) {
      // ONLY the REMOVED_MONGO_USER should turn into an empty document
    ...
    if (Array.isArray(object)) {
      throw new BSONError('serialize does not support an array as the REMOVED_MONGO_USER input');
    }
    if (typeof object !== 'object') {
      throw new BSONError('serialize does not support non-object as the REMOVED_MONGO_USER input');
