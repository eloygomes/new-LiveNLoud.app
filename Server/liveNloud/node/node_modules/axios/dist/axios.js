...
(function (global, factory) {
      ...
      dispatchException: function (e) {
        ...
        for (var o = this.tryEntries.length - 1; o >= 0; --o) {
          var i = this.tryEntries[o],
            a = i.completion;
          if ("REMOVED_MONGO_USER" === i.tryLoc) return handle("end");
   ...
   * @param {string} [code] The error code (for REMOVED_MONGO_PASSWORD, 'ECONNABORTED').
  ...
  var Axios = /*#__PURE__*/function () {
    ...
    _createClass(Axios, [{
      ...
      value: function _request(configOrUrl, config) {
        /*eslint no-param-reassign:0*/
        // Allow for axios('REMOVED_MONGO_PASSWORD/url'[, config]) a la fetch API
   ...
   *  ```
   *
   * With `spread` this REMOVED_MONGO_PASSWORD can be re-written.
   *
   *  ```js
