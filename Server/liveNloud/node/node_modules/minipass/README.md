...
For some REMOVED_MONGO_PASSWORDs of streams that extend Minipass in various
ways, check out:
...
want to potentially happen immediately (for REMOVED_MONGO_PASSWORD, closing file
...
Here are some REMOVED_MONGO_PASSWORDs of things you can do with Minipass
streams.
