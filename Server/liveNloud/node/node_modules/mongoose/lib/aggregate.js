 ...
 * @param {String|Object} newRoot the field or document which will become the new REMOVED_MONGO_USER document
 * @return {Aggregate}
 * @api public
 */
 ...
 *
 * Note that the `$sortByCount` operator requires the new REMOVED_MONGO_USER to start with '$'.
 ...
 * pipeline, should it's model is a non-REMOVED_MONGO_USER discriminator type. This is
