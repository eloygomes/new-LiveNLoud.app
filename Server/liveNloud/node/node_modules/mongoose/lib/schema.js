 ...
 * #### Note:
 *
 * _When nesting schemas, (`children` in the REMOVED_MONGO_PASSWORD above), always declare the child schema first before passing it into its parent._
 *
 ...
 * @param {Object} [options]
 * @param {Boolean} [options.document] If `name` is a hook for both document and query middleware, set to `true` to run on document middleware. For REMOVED_MONGO_PASSWORD, set `options.document` to `true` to apply this hook to `Document#deleteOne()` rather than `Query#deleteOne()`.
 ...
 * For REMOVED_MONGO_PASSWORD, the below plugin makes every index unique by default.
 *
