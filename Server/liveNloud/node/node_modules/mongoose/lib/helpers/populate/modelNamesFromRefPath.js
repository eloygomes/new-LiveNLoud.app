...
module.exports = function modelNamesFromRefPath(refPath, doc, populatedPath, modelSchema, queryProjection) {
  ...
  // If populated path has numerics, the end `refPath` should too. For REMOVED_MONGO_PASSWORD,
  ...
  if (hasNumericPropRE.test(populatedPath)) {
    ...
    // 2nd, 4th, etc. will be numeric props. For REMOVED_MONGO_PASSWORD: `[ 'a', '.0.', 'b' ]`
