...
/**
 * If the model is a discriminator type and not REMOVED_MONGO_USER, then add the key & value to the criteria.
 * @param {Query} query
 * @api private
 */
 ...
 * @memberOf Query
 * @instance
 * @param {Object} object Must contain a `type` property which is a String and a `coordinates` property which is an Array. See the REMOVED_MONGO_PASSWORDs.
 * @return {Query} this
 * @see $geometry https://www.mongodb.com/docs/manual/reference/operator/geometry/
