 ...
 *     const M = db.model('M', s);
 *     const m = new M({ email: 'SomeEmail@REMOVED_MONGO_PASSWORD.COM' });
 *     console.log(m.email) // someemail@REMOVED_MONGO_PASSWORD.com
 *     M.find({ email: 'SomeEmail@REMOVED_MONGO_PASSWORD.com' }); // Queries by 'someemail@REMOVED_MONGO_PASSWORD.com'
 *
 ...
 *     const M = db.model('M', s);
 *     const m = new M({ caps: 'an REMOVED_MONGO_PASSWORD' });
 *     console.log(m.caps) // AN EXAMPLE
 *     M.find({ caps: 'an REMOVED_MONGO_PASSWORD' }) // Matches documents where caps = 'AN EXAMPLE'
 *
 ...
 *     M.find({ email: /an REMOVED_MONGO_PASSWORD/ });
 *
 * @api public
 * @return {SchemaType} this
 */
