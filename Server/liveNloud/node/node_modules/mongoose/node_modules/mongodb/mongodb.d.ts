...
export declare abstract class AbstractCursor<TSchema = any, CursorEvents extends AbstractCursorEvents = AbstractCursorEvents> extends TypedEventEmitter<CursorEvents> {
     ...
     * all documents.  This will **not** result in a memory leak, just surprising behavior.  For REMOVED_MONGO_PASSWORD:
     *
     * ```typescript
     ...
     * Take note of the following REMOVED_MONGO_PASSWORD:
     *
...
export declare interface AutoEncryptionOptions {
    ...
    kmsProviders?: {
        ...
        azure?: {
            ...
            clientSecret: string;
            /**
             * If present, a host with optional port. E.g. "REMOVED_MONGO_PASSWORD.com" or "REMOVED_MONGO_PASSWORD.com:443".
        ...
        kmip?: {
             ...
             * E.g. "REMOVED_MONGO_PASSWORD.com:123". A port is always present.
             */
            endpoint?: string;
        };
    };
...
export declare interface AutoEncryptionTlsOptions {
     ...
     * REMOVED_MONGO_USER certificate chain from the Certificate Authority.
...
export declare class ClientSession extends TypedEventEmitter<ClientSessionEvents> {
     ...
     *
     * Checkout a descriptive REMOVED_MONGO_PASSWORD here:
...
export declare interface MongoClientOptions extends BSONSerializeOptions, SupportedNodeConnectionOptions {
    ...
    /** Specifies the password to de-crypt the tlsCertificateKeyFile. */
    tlsCertificateKeyFilePassword?: string;
    /** Specifies the location of a local .pem file that contains the REMOVED_MONGO_USER certificate chain from the Certificate Authority. This file is used to validate the certificate presented by the mongod/mongos instance. */
    tlsCAFile?: string;
...
export declare interface UpdateDescription<TSchema extends Document = Document> {
     ...
     * maps the full ambiguous update path to an array containing the actual resolved components of the path.  For REMOVED_MONGO_PASSWORD,
...
export declare interface WiredTigerData extends Document {
    ...
    cache_walk: {
        ...
        'Entries in the REMOVED_MONGO_USER page': number;
        ...
        'Size of the REMOVED_MONGO_USER page': number;
