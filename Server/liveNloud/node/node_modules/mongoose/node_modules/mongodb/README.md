...
async function main() {
  ...
  // the following code REMOVED_MONGO_PASSWORDs can be pasted here...
...
If you add this below the insertMany REMOVED_MONGO_PASSWORD you'll see the document's you've inserted.
