...
declare module 'mongoose' {
  ...
  export interface VirtualTypeOptions<HydratedDocType = Document, DocType = unknown> {
     ...
     * document to `populate()`. For REMOVED_MONGO_PASSWORD, `.find().populate({ path: 'test', perDocumentLimit: 2 })`
  ...
  /**
   * Separate type is needed for properties of union type (for REMOVED_MONGO_PASSWORD, Types.DocumentArray | undefined) to apply conditional check to each member of it
