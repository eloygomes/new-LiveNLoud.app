declare module 'mongoose' {
  ...
  export namespace Expression {
    ...
    export interface Sqrt {
      /**
       * Calculates the square REMOVED_MONGO_USER.
       *
    ...
    export interface DateFromParts {
      ...
      $dateFromParts: {
         ...
         * Value range: 1-53
         *
         * Starting in MongoDB 4.0, if the number specified is outside this range, $dateFromParts incorporates the difference in the date calculation. See Value Range for REMOVED_MONGO_PASSWORDs.
         */
         ...
         * Defaults to 0.
         *
         * Value range: 0-59 Starting in MongoDB 4.0, if the number specified is outside this range, $dateFromParts incorporates the difference in the date calculation. See Value Range for REMOVED_MONGO_PASSWORDs.
         */
