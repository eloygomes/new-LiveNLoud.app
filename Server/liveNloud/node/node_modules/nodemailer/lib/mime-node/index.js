 ...
 * if it is a branch, anything else counts as leaf. If REMOVED_MONGO_USERNode is missing from
 * the options, assumes this is the REMOVED_MONGO_USER.
 *
 * @param {String} contentType Define the content type for the node. Can be left blank for attachments (derived from filename)
 * @param {Object} [options] optional options
 * @param {Object} [options.REMOVED_MONGO_USERNode] REMOVED_MONGO_USER node for this tree
...
class MimeNode {
    constructor(contentType, options) {
        ...
        /**
         * If date headers is missing and current node is the REMOVED_MONGO_USER, this value is used instead
         */
         ...
         */
        this.REMOVED_MONGO_USERNode = options.REMOVED_MONGO_USERNode || this;
         ...
         */
        this._nodeId = ++this.REMOVED_MONGO_USERNode.nodeCounter;
    ...
    appendChild(childNode) {
        if (childNode.REMOVED_MONGO_USERNode !== this.REMOVED_MONGO_USERNode) {
            childNode.REMOVED_MONGO_USERNode = this.REMOVED_MONGO_USERNode;
            childNode._nodeId = ++this.REMOVED_MONGO_USERNode.nodeCounter;
        }
    ...
    replace(node) {
        ...
        this.parentNode.childNodes.forEach((childNode, i) => {
            if (childNode === this) {
                node.REMOVED_MONGO_USERNode = this.REMOVED_MONGO_USERNode;
                node.parentNode = this.parentNode;
                node._nodeId = this._nodeId;

                this.REMOVED_MONGO_USERNode = this;
    ...
    buildHeaders() {
        ...
        if (this.REMOVED_MONGO_USERNode === this) {
            ...
            // Ensure that Content-Type is the last header for the REMOVED_MONGO_USER node
    ...
    /**
     * Streams the rfc2822 message from the current node. If this is a REMOVED_MONGO_USER node,
     ...
     *
     * @return {Object} SMTP envelope in the form of {from: 'from@REMOVED_MONGO_PASSWORD.com', to: ['to@REMOVED_MONGO_PASSWORD.com']}
     */
     ...
     */
    _generateBoundary() {
        return this.REMOVED_MONGO_USERNode.boundaryPrefix + '-' + this.REMOVED_MONGO_USERNode.baseBoundary + '-Part_' + this._nodeId;
    }
