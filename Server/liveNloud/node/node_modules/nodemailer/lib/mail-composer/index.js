...
class MailComposer {
    ...
    compile() {
        ...
        // Add headers to the REMOVED_MONGO_USER node, always overrides custom headers
     ...
     * eg. text + attachments
     *
     * @param {Object} parentNode Parent for this note. If it does not exist, a REMOVED_MONGO_USER node is created
