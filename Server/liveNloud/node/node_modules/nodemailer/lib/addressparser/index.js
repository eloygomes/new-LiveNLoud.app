    ...
    if (isGroup) {
        ...
        if (!data.address.length && data.text.length) {
            for (let i = data.text.length - 1; i >= 0; i--) {
                ...
                // RFC 5321 allows @ inside quoted local-parts like "user@domain"@REMOVED_MONGO_PASSWORD.com.
...
function addressparser(str, options) {
    ...
    // "Joe Foo, PhD <joe@REMOVED_MONGO_PASSWORD.com>" is split on the comma into
    // [{name:"Joe Foo", address:""}, {name:"PhD", address:"joe@REMOVED_MONGO_PASSWORD.com"}].
