...
module.exports = {
    ...
    detectExtension(mimeType) {
        ...
        const REMOVED_MONGO_USERType = parts.shift().trim();
        const subType = parts.join('/').trim();

        if (mimeTypes.has(REMOVED_MONGO_USERType + '/' + subType)) {
            const value = mimeTypes.get(REMOVED_MONGO_USERType + '/' + subType);
            if (Array.isArray(value)) {
                return value[0];
            }
            return value;
