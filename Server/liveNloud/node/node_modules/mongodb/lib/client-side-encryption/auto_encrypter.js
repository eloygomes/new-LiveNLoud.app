...
class AutoEncrypter {
     ...
     *
     * @REMOVED_MONGO_PASSWORD <caption>Create an AutoEncrypter that makes use of mongocryptd</caption>
     * ```ts
     ...
     * @REMOVED_MONGO_PASSWORD <caption>Create an AutoEncrypter that makes use of libmongocrypt's CSFLE shared library</caption>
     * ```ts
