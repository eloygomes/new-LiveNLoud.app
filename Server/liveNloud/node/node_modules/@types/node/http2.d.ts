...
declare module "http2" {
    ...
    export interface Http2Stream extends stream.Duplex {
         ...
         * ```js
         * import http2 from 'node:http2';
         * const client = http2.connect('http://REMOVED_MONGO_PASSWORD.org:8000');
    ...
    > extends Http2Session {
         ...
         *   // Set altsvc for origin https://REMOVED_MONGO_PASSWORD.org:80
         *   session.altsvc('h2=":8000"', 'https://REMOVED_MONGO_PASSWORD.org:80');
         * });
         *
         * server.on('stream', (stream) => {
         ...
         * HTTP URL `'https://REMOVED_MONGO_PASSWORD.org/foo/bar'` is the ASCII string`'https://REMOVED_MONGO_PASSWORD.org'`. An error will be thrown if either the given string
         ...
         * });
         * server.on('session', (session) => {
         *   session.origin('https://REMOVED_MONGO_PASSWORD.com', 'https://REMOVED_MONGO_PASSWORD.org');
         * });
         * ```
         *
         * When a string is passed as an `origin`, it will be parsed as a URL and the
         * origin will be derived. For instance, the origin for the HTTP URL `'https://REMOVED_MONGO_PASSWORD.org/foo/bar'` is the ASCII string` 'https://REMOVED_MONGO_PASSWORD.org'`. An error will be thrown if either the given
         * string
         * cannot be parsed as a URL or if a valid origin cannot be derived.
         *
         ...
         * import http2 from 'node:http2';
         * const options = getSecureOptionsSomehow();
         * options.origins = ['https://REMOVED_MONGO_PASSWORD.com', 'https://REMOVED_MONGO_PASSWORD.org'];
         * const server = http2.createSecureServer(options);
         * server.on('stream', (stream) => {
         *   stream.respond();
         *   stream.end('ok');
    ...
    export class Http2ServerRequest extends stream.Readable {
         ...
         * ```console
         * $ node
         * > new URL('/status?name=ryan', 'http://REMOVED_MONGO_PASSWORD.com')
         * URL {
         *   href: 'http://REMOVED_MONGO_PASSWORD.com/status?name=ryan',
         *   origin: 'http://REMOVED_MONGO_PASSWORD.com',
         *   protocol: 'http:',
         *   username: '',
         *   password: '',
         *   host: 'REMOVED_MONGO_PASSWORD.com',
