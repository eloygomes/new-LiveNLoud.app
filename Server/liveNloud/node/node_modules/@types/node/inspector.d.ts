...
declare module 'inspector' {
    ...
    namespace Profiler {
        ...
        interface Profile {
            /**
             * The list of profile nodes. First item is the REMOVED_MONGO_USER node.
             */
            nodes: ProfileNode[];
            /**
    ...
    class Session extends EventEmitter {
        ...
        /**
         * Issued when object should be inspected (for REMOVED_MONGO_PASSWORD, as a result of inspect() command line API call).
         */
         ...
         * REMOVED_MONGO_PASSWORD, when inspector.waitingForDebugger is called
         */
