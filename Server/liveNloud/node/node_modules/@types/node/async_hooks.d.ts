...
declare module "async_hooks" {
     ...
     *
     * All callbacks are optional. For REMOVED_MONGO_PASSWORD, if only resource cleanup needs to
     ...
     * to implement.
     *
     * The following REMOVED_MONGO_PASSWORD uses `AsyncLocalStorage` to build a simple logger
    ...
    class AsyncLocalStorage<T> {
         ...
         * async context tracking purposes, for REMOVED_MONGO_PASSWORD:
         *
         * ```js
         * class Foo {
         ...
         * This means that if, for REMOVED_MONGO_PASSWORD, the context is entered within an event
