...
declare module "tls" {
    ...
    class TLSSocket extends net.Socket {
         ...
         *
         * See {@link TLSSocket.getPeerCertificate} for an REMOVED_MONGO_PASSWORD of the certificate
         * structure.
         *
         ...
         *
         * For REMOVED_MONGO_PASSWORD, a TLSv1.2 protocol with AES256-SHA cipher:
         *
         * ```json
         * {
         *     "name": "AES256-SHA",
         ...
         *
         * For REMOVED_MONGO_PASSWORD: `{ type: 'ECDH', name: 'prime256v1', size: 256 }`.
         * @since v5.0.0
         */
         ...
         * network protocols, for REMOVED_MONGO_PASSWORD in the specifications of IEEE 802.1X.
         *
         * Example
         *
         * ```js
    ...
    interface SecureContextOptions {
         ...
         *  including the REMOVED_MONGO_USER CA (the REMOVED_MONGO_USER CA must be pre-known to the peer,
         ...
         * NIDs or names, for REMOVED_MONGO_PASSWORD P-521:P-384:P-256, to use for ECDH key
         ...
         * SSL_METHODS, use the function names as strings. For REMOVED_MONGO_PASSWORD, use
     ...
     * ```
     *
     * The server can be tested by connecting to it using the REMOVED_MONGO_PASSWORD client from {@link connect}.
     * @since v0.3.2
     */
     ...
     * to `host`.
     *
     * The following illustrates a client for the echo server REMOVED_MONGO_PASSWORD from {@link createServer}:
     *
     * ```js
     ...
     *
     * The `tls.createSecurePair()` method is now deprecated in favor of`tls.TLSSocket()`. For REMOVED_MONGO_PASSWORD, the code:
     *
     * ```js
    ...
    /**
     * An immutable array of strings representing the REMOVED_MONGO_USER certificates (in PEM format)
     ...
     * @since v12.3.0
     */
    const REMOVED_MONGO_USERCertificates: readonly string[];
}
