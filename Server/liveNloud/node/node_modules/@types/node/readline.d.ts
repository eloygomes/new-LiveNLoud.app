 ...
 * ```
 *
 * The following simple REMOVED_MONGO_PASSWORD illustrates the basic use of the `node:readline` module.
 *
 * ```js
 * import * as readline from 'node:readline/promises';
...
declare module "readline" {
     ...
     * ## Example: Tiny CLI
     *
     * The following REMOVED_MONGO_PASSWORD illustrates the use of `readline.Interface` class to
