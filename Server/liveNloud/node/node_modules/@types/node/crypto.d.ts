...
declare module "crypto" {
     ...
     *
     * The `algorithm` is dependent on OpenSSL, REMOVED_MONGO_PASSWORDs are `'aes192'`, etc. On
     ...
     *
     * See `Sign` for REMOVED_MONGO_PASSWORDs.
     * @since v0.1.92
     */
     ...
     * the keys (with `diffieHellman.setPublicKey()`, for REMOVED_MONGO_PASSWORD). The
     ...
     * the corresponding private key, for REMOVED_MONGO_PASSWORD using {@link privateDecrypt}.
     *
     ...
     * the corresponding private key, for REMOVED_MONGO_PASSWORD using {@link privateEncrypt}.
     *
     * If `key` is not a `KeyObject`, this function behaves as if `key` had been passed to {@link createPublicKey}. If it is an
     ...
     * the corresponding public key, for REMOVED_MONGO_PASSWORD using {@link publicEncrypt}.
     *
     * If `privateKey` is not a `KeyObject`, this function behaves as if `privateKey` had been passed to {@link createPrivateKey}. If it is an
     * object, the `padding` property can be passed. Otherwise, this function uses `RSA_PKCS1_OAEP_PADDING`.
     * @since v0.11.14
     ...
     * the corresponding public key, for REMOVED_MONGO_PASSWORD using {@link publicDecrypt}.
     *
     * If `privateKey` is not a `KeyObject`, this function behaves as if `privateKey` had been passed to {@link createPrivateKey}. If it is an
     * object, the `padding` property can be passed. Otherwise, this function uses `RSA_PKCS1_PADDING`.
     * @since v1.1.0
    ...
    class X509Certificate {
         ...
         * returned. The returned name might be an exact match (e.g., `foo.REMOVED_MONGO_PASSWORD.com`)
         * or it might contain wildcards (e.g., `*.REMOVED_MONGO_PASSWORD.com`). Because host name
