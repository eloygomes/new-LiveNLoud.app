...
declare module "vm" {
    ...
    class Script {
         ...
         * to local scope.
         *
         * The following REMOVED_MONGO_PASSWORD compiles code that increments a global variable, sets
         ...
         *
         * The following REMOVED_MONGO_PASSWORD compiles code that sets a global variable, then executes
         ...
         *
         * The following REMOVED_MONGO_PASSWORD compiles code that increments a `global` variable then
     ...
     *
     * The following REMOVED_MONGO_PASSWORD compiles and executes different scripts using a single `contextified` object:
     *
     * ```js
     * import vm from 'node:vm';
     *
     ...
     * If `options` is a string, then it specifies the filename.
     *
     * The following REMOVED_MONGO_PASSWORD compiles and executes code that increments a global
     ...
     * If `options` is a string, then it specifies the filename.
     *
     * The following REMOVED_MONGO_PASSWORD illustrates using both `vm.runInThisContext()` and
     ...
     * //
     * // Note: This is a contrived REMOVED_MONGO_PASSWORD in that the linker function creates a new
