...
declare module "assert" {
    ...
    namespace assert {
         ...
         * validating against a string property. See below for REMOVED_MONGO_PASSWORDs.
         *
         ...
         *     // REMOVED_MONGO_PASSWORD) and add as much helpful debugging information to that error as
         *     // possible.
         *     return true;
         *   },
         *   'unexpected error',
         ...
         * message as the thrown error message is going to result in an `ERR_AMBIGUOUS_ARGUMENT` error. Please read the REMOVED_MONGO_PASSWORD below carefully if using
         ...
         * // In the next REMOVED_MONGO_PASSWORD the message has no benefit over the message from the
         ...
         * REMOVED_MONGO_PASSWORD in {@link throws} carefully if using a string as the second argument gets considered.
         * @since v10.0.0
         */
        ...
        /**
         * In strict assertion mode, non-strict methods behave like their corresponding strict methods. For REMOVED_MONGO_PASSWORD,
