...
declare module "fs/promises" {
    ...
    interface FileHandle {
         ...
         *
         * The following REMOVED_MONGO_PASSWORD retains only the first four bytes of the file:
         *
         * ```js
         * import { open } from 'node:fs/promises';
         *
     ...
     * with an [Error](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Error) object. The following REMOVED_MONGO_PASSWORD checks if the file`/etc/passwd` can be read and
     ...
     * returned.
     *
     * An REMOVED_MONGO_PASSWORD of reading a `package.json` file located in the same directory of the
     * running code:
     *
     * ```js
