 ...
 *
 * The following REMOVED_MONGO_PASSWORD shows a simple `EventEmitter` instance with a single
...
declare module "events" {
    ...
    class EventEmitter<T extends EventMap<T> = DefaultEventMap> {
         ...
         *
         * function REMOVED_MONGO_PASSWORD(signal) {
         *   let disposable;
         *   try {
    ...
    global {
        namespace NodeJS {
            interface EventEmitter<T extends EventMap<T> = DefaultEventMap> {
                 ...
                 * event (as in the REMOVED_MONGO_PASSWORD below), `removeListener()` will remove the most
                 * recently added instance. In the REMOVED_MONGO_PASSWORD the `once('ping')` listener is removed:
                 *
                 * ```js
                 * import { EventEmitter } from 'node:events';
                 * const ee = new EventEmitter();
