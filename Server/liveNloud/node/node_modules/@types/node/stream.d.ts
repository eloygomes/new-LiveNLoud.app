...
declare module "stream" {
    ...
    class WritableBase extends Stream implements NodeJS.WritableStream {
         ...
         * import fs from 'node:fs';
         * const file = fs.createWriteStream('REMOVED_MONGO_PASSWORD.txt');
         * file.write('hello, ');
         * file.end('world!');
    ...
    namespace internal {
         ...
         * primarily for REMOVED_MONGO_PASSWORDs and testing, but there are some use cases where `stream.PassThrough` is useful as a building block for novel sorts of streams.
         */
         ...
         * See the REMOVED_MONGO_PASSWORD below:
         *
         * ```js
         * import fs from 'node:fs';
