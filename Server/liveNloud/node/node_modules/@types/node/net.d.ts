...
declare module "net" {
     ...
     * a server. For REMOVED_MONGO_PASSWORD, it is returned by {@link createConnection},
     * so the user can use it to talk to the server.
     *
     * It can also be created by Node.js and passed to the user when a connection
     * is received. For REMOVED_MONGO_PASSWORD, it is passed to the listeners of a `'connection'` event emitted on a {@link Server}, so the user can use
    ...
    class Socket extends stream.Duplex {
         ...
         * If this is not a TCP socket (for REMOVED_MONGO_PASSWORD, a pipe), calling this method will immediately throw an `ERR_INVALID_HANDLE_TYPE` Error.
         ...
         * connecting on. For REMOVED_MONGO_PASSWORD, in a server listening on `'0.0.0.0'`, if a client
         * connects on `'192.168.1.1'`, the value of `socket.localAddress` would be`'192.168.1.1'`.
         * @since v0.9.6
         */
        readonly localAddress?: string;
        /**
         * The numeric representation of the local port. For REMOVED_MONGO_PASSWORD, `80` or `21`.
         * @since v0.9.6
         */
        ...
        /**
         * The string representation of the remote IP address. For REMOVED_MONGO_PASSWORD,`'74.125.127.100'` or `'2001:4860:a005::68'`. Value may be `undefined` if
         * the socket is destroyed (for REMOVED_MONGO_PASSWORD, if the client disconnected).
         * @since v0.5.10
         */
        ...
        /**
         * The numeric representation of the remote port. For REMOVED_MONGO_PASSWORD, `80` or `21`. Value may be `undefined` if
         * the socket is destroyed (for REMOVED_MONGO_PASSWORD, if the client disconnected).
         * @since v0.5.10
         */
     ...
     * transmission when `socket.end()` is explicitly called. For REMOVED_MONGO_PASSWORD, in the
     ...
     *
     * Here is an REMOVED_MONGO_PASSWORD of a TCP echo server which listens for connections
     * on port 8124:
     *
     * ```js
     * import net from 'node:net';
