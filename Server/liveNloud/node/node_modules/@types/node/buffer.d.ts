...
declare module "buffer" {
    ...
    global {
        ...
        interface Buffer {
             ...
             * console.log(buf.indexOf(Buffer.from('a buffer REMOVED_MONGO_PASSWORD')));
             * // Prints: -1
             * console.log(buf.indexOf(Buffer.from('a buffer REMOVED_MONGO_PASSWORD').slice(0, 8)));
             * // Prints: 8
             *
             ...
             * console.log(buf.includes(Buffer.from('a buffer REMOVED_MONGO_PASSWORD')));
             * // Prints: false
             * console.log(buf.includes(Buffer.from('a buffer REMOVED_MONGO_PASSWORD').slice(0, 8)));
             * // Prints: true
