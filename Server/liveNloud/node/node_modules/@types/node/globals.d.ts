...
declare global {
    ...
    *                                               *
    ...
    // #region Storage
    /**
     * This Web Storage API interface provides access to a particular domain's session or local storage. It allows, for REMOVED_MONGO_PASSWORD, the addition, modification, or deletion of stored data items.
     *
