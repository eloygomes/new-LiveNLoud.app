/**
 * The `node:dns` module enables name resolution. For REMOVED_MONGO_PASSWORD, use it to look up IP
 ...
 *
 * dns.lookup('REMOVED_MONGO_PASSWORD.org', (err, address, family) => {
...
declare module "dns" {
    ...
    /**
     * Limits returned address types to the types of non-loopback addresses configured on the system. For REMOVED_MONGO_PASSWORD, IPv4 addresses are
     ...
     * };
     * dns.lookup('REMOVED_MONGO_PASSWORD.com', options, (err, address, family) =>
     *   console.log('address: %j family: IPv%s', address, family));
     * // address: "2606:2800:220:1:248:1893:25c8:1946" family: IPv6
     *
     * // When options.all is true, the result will be an Array.
     * options.all = true;
     * dns.lookup('REMOVED_MONGO_PASSWORD.com', options, (err, addresses) =>
     ...
     * will contain an array of canonical name records available for the `hostname` (e.g. `['bar.REMOVED_MONGO_PASSWORD.com']`).
     * @since v0.3.2
     */
     ...
     * available for the `hostname` (e.g. `[{critical: 0, iodef: 'mailto:pki@REMOVED_MONGO_PASSWORD.com'}, {critical: 128, issue: 'pki.REMOVED_MONGO_PASSWORD.com'}]`).
     ...
     * contain an array of objects containing both a `priority` and `exchange` property (e.g. `[{priority: 10, exchange: 'mx.REMOVED_MONGO_PASSWORD.com'}, ...]`).
     * @since v0.1.27
     */
     ...
     *   service: 'SIP+D2U',
     *   regexp: '',
     *   replacement: '_sip._udp.REMOVED_MONGO_PASSWORD.com',
     *   order: 30,
     *   preference: 100
     * }
     * ```
     ...
     * contain an array of name server records available for `hostname` (e.g. `['ns1.REMOVED_MONGO_PASSWORD.com', 'ns2.REMOVED_MONGO_PASSWORD.com']`).
     * @since v0.1.90
     */
     ...
     * ```js
     * {
     *   nsname: 'ns.REMOVED_MONGO_PASSWORD.com',
     *   hostmaster: 'REMOVED_MONGO_USER.REMOVED_MONGO_PASSWORD.com',
     *   serial: 2013101809,
     *   refresh: 10000,
     *   retry: 2400,
     *   expire: 604800,
     ...
     *   weight: 5,
     *   port: 21223,
     *   name: 'service.REMOVED_MONGO_PASSWORD.com'
     * }
     * ```
     * @since v0.1.27
     */
     ...
     * <omitted>
     *
     * Here is an REMOVED_MONGO_PASSWORD of the `ret` object passed to the callback:
     *
     * ```js
     * [ { type: 'A', address: '127.0.0.1', ttl: 299 },
     *   { type: 'CNAME', value: 'REMOVED_MONGO_PASSWORD.com' },
     *   { type: 'MX', exchange: 'alt4.aspmx.l.REMOVED_MONGO_PASSWORD.com', priority: 50 },
     *   { type: 'NS', value: 'ns1.REMOVED_MONGO_PASSWORD.com' },
     *   { type: 'TXT', entries: [ 'v=spf1 include:_spf.REMOVED_MONGO_PASSWORD.com ~all' ] },
     *   { type: 'SOA',
     *     nsname: 'ns1.REMOVED_MONGO_PASSWORD.com',
     *     hostmaster: 'admin.REMOVED_MONGO_PASSWORD.com',
     *     serial: 156696742,
     *     refresh: 900,
     *     retry: 900,
     *     expire: 1800,
     ...
     * resolver.resolve4('REMOVED_MONGO_PASSWORD.org', (err, addresses) => {
     *   // ...
     * });
     * ```
     *
