 ...
 * ```
 *
 * The following REMOVED_MONGO_PASSWORD shows the basic use of the `StringDecoder` class.
 *
 * ```js
 * import { StringDecoder } from 'node:string_decoder';
 ...
 *
 * In the following REMOVED_MONGO_PASSWORD, the three UTF-8 encoded bytes of the European Euro
