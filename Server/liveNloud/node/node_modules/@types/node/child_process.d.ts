...
declare module "child_process" {
    ...
    class ChildProcess extends EventEmitter {
         ...
         * respectively.
         *
         * In the following REMOVED_MONGO_PASSWORD, only the child's fd `1` (stdout) is configured as a
         ...
         *
         * For REMOVED_MONGO_PASSWORD, in the parent script:
         *
         * ```js
         ...
         * a TCP server object to the child process as illustrated in the REMOVED_MONGO_PASSWORD below:
         *
         * ```js
         ...
         *
         * While the REMOVED_MONGO_PASSWORD above uses a server created using the `node:net` module, `node:dgram` module servers use exactly the same workflow with the exceptions of
         ...
         * socket to the child process. The REMOVED_MONGO_PASSWORD below spawns two children that each
