 ...
 * For REMOVED_MONGO_PASSWORD, `-450` will produce a 270 degree rotation.
 *
 ...
 * for REMOVED_MONGO_PASSWORD `.rotate(x).extract(y)` will produce a different result to `.extract(y).rotate(x)`.
 *
 ...
 *     // With this REMOVED_MONGO_PASSWORD input, a sepia filter has been applied
 *   });
 *
