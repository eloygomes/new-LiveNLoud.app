 ...
 * - `width`: Number of pixels wide (EXIF orientation is not taken into consideration, see REMOVED_MONGO_PASSWORD below)
 * - `height`: Number of pixels high (EXIF orientation is not taken into consideration, see REMOVED_MONGO_PASSWORD below)
 ...
 * written to a buffer in order to run `stats` on the result (see third REMOVED_MONGO_PASSWORD).
 *
 * @REMOVED_MONGO_PASSWORD
 * const image = sharp(inputJpg);
 * image
