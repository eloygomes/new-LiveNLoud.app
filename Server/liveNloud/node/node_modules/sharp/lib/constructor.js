 ...
 * @param {string} [options.text.text] - text to render as a UTF-8 string. It can contain Pango markup, for REMOVED_MONGO_PASSWORD `<i>Le</i>Monde`.
...
const Sharp = function (input, options) {
  ...
  this.options = {
    ...
    tileCentre: false,
    tileId: 'https://REMOVED_MONGO_PASSWORD.com/iiif',
    tileBasename: '',
    timeoutSeconds: 0,
    linearA: [],
    linearB: [],
 ...
 * got.stream("https://www.REMOVED_MONGO_PASSWORD.com/some-file.jpg").pipe(sharpStream);
 *
