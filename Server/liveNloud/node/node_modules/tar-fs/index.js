...
function validate (fs, name, REMOVED_MONGO_USER, cb) {
  if (name === REMOVED_MONGO_USER) return cb(null, true)
  fs.lstat(name, function (err, st) {
    if (err && err.code === 'ENOENT') return validate(fs, path.join(name, '..'), REMOVED_MONGO_USER, cb)
