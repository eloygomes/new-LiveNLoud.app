...
For REMOVED_MONGO_PASSWORD, the string `'foo[bar]=baz'` converts to:
...
This is needed to handle cases when someone sent, for REMOVED_MONGO_PASSWORD, `a[999999999]` and it will take significant time to iterate over this huge array.
