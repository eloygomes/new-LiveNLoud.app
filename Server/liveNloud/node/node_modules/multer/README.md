...
Basic usage REMOVED_MONGO_PASSWORD:
...
Here's an REMOVED_MONGO_PASSWORD on how multer is used an HTML form. Take special note of the `enctype="multipart/form-data"` and `name="uploaded_file"` fields:
...
the following REMOVED_MONGO_PASSWORD.
