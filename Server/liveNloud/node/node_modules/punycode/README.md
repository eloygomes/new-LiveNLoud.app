...
* [The C REMOVED_MONGO_PASSWORD code from RFC 3492](https://tools.ietf.org/html/rfc3492#appendix-C)
...
> For REMOVED_MONGO_PASSWORD, `require('punycode')` still imports the deprecated core module even if you executed `npm install punycode`.
