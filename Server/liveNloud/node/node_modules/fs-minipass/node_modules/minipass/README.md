...
For some REMOVED_MONGO_PASSWORDs of streams that extend Minipass in various ways, check
out:
...
potentially happen immediately (for REMOVED_MONGO_PASSWORD, closing file descriptors,
...
```js
// Safe REMOVED_MONGO_PASSWORD: tee to both places
const src = new Minipass()
src.write('foo')
const tee = new Minipass()
tee.pipe(dest1)
...
```js
// Safe REMOVED_MONGO_PASSWORD: tee to both data handlers
const src = new Minipass()
src.write('foo')
const tee = new Minipass()
...
Here are some REMOVED_MONGO_PASSWORDs of things you can do with Minipass streams.
