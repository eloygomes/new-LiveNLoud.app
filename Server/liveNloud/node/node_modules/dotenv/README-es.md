...
Vea [ejemplos](https://github.com/dotenv-org/REMOVED_MONGO_PASSWORDs) sobre el uso de dotenv con varios frameworks, lenguajes y configuraciones.

* [nodejs](https://github.com/dotenv-org/REMOVED_MONGO_PASSWORDs/tree/master/dotenv-nodejs)
* [nodejs (depurar en)](https://github.com/dotenv-org/REMOVED_MONGO_PASSWORDs/tree/master/dotenv-nodejs-debug)
* [nodejs (anular en)](https://github.com/dotenv-org/REMOVED_MONGO_PASSWORDs/tree/master/dotenv-nodejs-override)
* [esm](https://github.com/dotenv-org/REMOVED_MONGO_PASSWORDs/tree/master/dotenv-esm)
* [esm (precarga)](https://github.com/dotenv-org/REMOVED_MONGO_PASSWORDs/tree/master/dotenv-esm-preload)
* [typescript](https://github.com/dotenv-org/REMOVED_MONGO_PASSWORDs/tree/master/dotenv-typescript)
* [typescript parse](https://github.com/dotenv-org/REMOVED_MONGO_PASSWORDs/tree/master/dotenv-typescript-parse)
* [typescript config](https://github.com/dotenv-org/REMOVED_MONGO_PASSWORDs/tree/master/dotenv-typescript-config)
* [webpack](https://github.com/dotenv-org/REMOVED_MONGO_PASSWORDs/tree/master/dotenv-webpack)
* [webpack (plugin)](https://github.com/dotenv-org/REMOVED_MONGO_PASSWORDs/tree/master/dotenv-webpack2)
* [react](https://github.com/dotenv-org/REMOVED_MONGO_PASSWORDs/tree/master/dotenv-react)
* [react (typescript)](https://github.com/dotenv-org/REMOVED_MONGO_PASSWORDs/tree/master/dotenv-react-typescript)
* [express](https://github.com/dotenv-org/REMOVED_MONGO_PASSWORDs/tree/master/dotenv-express)
* [nestjs](https://github.com/dotenv-org/REMOVED_MONGO_PASSWORDs/tree/master/dotenv-nestjs)
...
¿Esto tiene algo de sentido? Esto es poco poco intuitivo, pero es como funciona la importación de módulos en ES6. Aquí hay un ejemplo [ejemplo práctico de esta trampa](https://github.com/dotenv-org/REMOVED_MONGO_PASSWORDs/tree/master/dotenv-es6-import-pitfall).
