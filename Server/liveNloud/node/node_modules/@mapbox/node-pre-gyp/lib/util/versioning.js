...
module.exports.evaluate = function(package_json, options, napi_build_version) {
  ...
  if (options.module_REMOVED_MONGO_USER) {
    // resolve relative to known module REMOVED_MONGO_USER: works for pre-binding require
    opts.module_path = path.join(options.module_REMOVED_MONGO_USER, opts.module_path);
  } else {
