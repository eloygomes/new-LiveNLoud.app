...
confirm_phrase \
  "DEPLOY DIST TO SUSTENIDO" \
  "This will deploy the current local Front/dist folder to SUSTENIDO."

deploy_front_dist sustenido
run_healthcheck sustenido
echo "Front dist deploy finished: sustenido"
