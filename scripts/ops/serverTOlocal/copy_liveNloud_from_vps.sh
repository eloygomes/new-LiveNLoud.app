...
REMOTE_DIR="${LIVE_SERVER_TO_LOCAL_REMOTE_DIR:-/home/liveNloud}"
LOCAL_DIR="$REPO_DIR/Server/liveNloud"

echo "Copying liveNloud from VPS to local..."
...
echo "liveNloud copy finished: $LOCAL_DIR"
