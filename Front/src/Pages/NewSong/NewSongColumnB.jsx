...
function NewSongColumnBMobile(props) {
  ...
  return (
    <div
      className={`${props.touchSection && props.touchSection !== "links" ? "hidden" : "block"} order-2 rounded-[18px] border border-black/5 bg-white/60 p-3 shadow-[0_8px_20px_rgba(0,0,0,0.06)]`}
    >
      <button
        type="button"
        className="flex w-full items-center justify-between"
    ...
    >
      <div className="flex items-center justify-between gap-2">
        <div className="flex min-w-0 items-center gap-2">
          <div
            className={`flex shrink-0 items-center justify-center rounded-[9px] text-black ${
              compact ? "h-7 w-7" : "h-11 w-11"
            } ${
              hasLink ? "bg-[goldenrod]/15 text-[goldenrod]" : "bg-black/[0.035] text-gray-400"
            }`}
          >
            <Icon className={compact ? "text-[11px]" : "text-[14px]"} />
          </div>
          {compact ? (
            <div className={`truncate text-[12px] font-black ${hasLink ? "text-black" : "text-gray-400"}`}>
              {label}
            </div>
          ) : null}
        </div>
      ...
      {compact ? (
        <div className="mt-2 h-1 overflow-hidden rounded-full bg-black/[0.05]">
          <span
            className="block h-full rounded-full bg-[goldenrod] transition-[width]"
  ...
  return createPortal(
    <div className="fixed inset-0 z-[13000] bg-black/35">
      ...
      <div className="absolute inset-x-0 bottom-0 max-h-[82dvh] overflow-x-hidden overflow-y-auto rounded-t-[24px] bg-[#f2f2f2] px-4 pb-[calc(1rem+env(safe-area-inset-bottom))] pt-3 shadow-[0_-12px_32px_rgba(0,0,0,0.16)] md:left-1/2 md:top-1/2 md:bottom-auto md:max-h-[86vh] md:w-[min(1120px,94vw)] md:origin-center md:-translate-x-1/2 md:-translate-y-1/2 md:scale-[0.8] md:overflow-visible md:rounded-[28px] md:px-5">
        ...
        <div className="mb-3 flex items-start justify-between gap-3">
          <div className="min-w-0">
            ...
            <div className="mt-1.5 flex items-center gap-2.5 text-[1.35rem] font-black tracking-tight text-black md:text-[2rem]">
              <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-[10px] bg-[goldenrod]/15 text-[goldenrod] md:h-11 md:w-11 md:rounded-[14px] md:text-[1.15rem]">
        ...
        <div className="rounded-[18px] bg-white/45 p-2.5 shadow-[0_6px_18px_rgba(0,0,0,0.05)] [&_.neuphormism-b]:!m-0 [&_.neuphormism-b]:!rounded-[16px] [&_.neuphormism-b]:!bg-transparent [&_.neuphormism-b]:!p-0 [&_.neuphormism-b]:!shadow-none md:p-3">
