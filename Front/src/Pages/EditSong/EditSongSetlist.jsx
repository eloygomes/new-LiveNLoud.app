      ...
      <div className="flex items-center justify-between gap-3">
        ...
        <div className="flex gap-2">
          <button
            ...
            className={`${compact ? "h-8 w-8 rounded-[9px] bg-[goldenrod]/15 p-0 text-[12px]" : "rounded-[8px] px-4 py-2 text-sm neuphormism-b-btn"} font-bold transition-colors`}
          ...
          {!isEditing ? (
            <button
              type="button"
              onClick={startEditing}
              className={`${compact ? "h-8 rounded-[9px] bg-white/75 px-2.5 text-[10px]" : "rounded-[8px] px-4 py-2 text-sm neuphormism-b-btn"} font-bold transition-colors`}
            >
              Edit
            </button>
          ) : (
            <>
              <button
                type="button"
                onClick={cancelEditing}
                className={`${compact ? "h-8 rounded-[9px] bg-white/75 px-2 text-[9px]" : "rounded-[8px] px-4 py-2 text-sm neuphormism-b-btn"} font-bold transition-colors`}
              >
                Cancel
              </button>
              ...
              <button
                type="button"
                onClick={saveChanges}
                className={`${compact ? "h-8 rounded-[9px] bg-[goldenrod]/15 px-2 text-[9px]" : "rounded-[8px] px-4 py-2 text-sm neuphormism-b-btn"} font-bold transition-colors disabled:opacity-60`}
                disabled={pendingRemovals.length === 0}
              >
                Save
              </button>
      ...
      <div className={compact ? "mt-3" : "mt-5"}>
        ...
        <div className="flex flex-row items-center gap-2">
          <input
            id="newSetlistName"
            type="text"
            className={`${compact ? "h-10 rounded-[10px] border border-gray-300 px-3 text-[12px]" : "rounded border-0 px-2 py-1 text-sm"} w-full bg-white outline-none`}
            placeholder="Ex: 'Show2023' ou 'Ensaios'"
            value={newSetlistName}
