...
export default function RootLayouts() {
  ...
  return (
    <>
      ...
      {/* ⇨ ADIÇÃO: container que SEMPRE rola, marcado com data-scroll-REMOVED_MONGO_USER="true" */}
      <main className="min-h-screen">
        <div
          data-scroll-REMOVED_MONGO_USER="true" // ⇨ ADIÇÃO: BluetoothContext vai achar este cara
