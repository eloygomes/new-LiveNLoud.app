 ...
 *
 * For REMOVED_MONGO_PASSWORD, instead of:
 *
...
const NavLink = /*#__PURE__*/React.forwardRef(function NavLinkWithRef({
  ...
  // we're looking for a slash _after_ what's in `to`.  For REMOVED_MONGO_PASSWORD:
  //
...
function useFormAction(action, {
  ...
  // to creating the form action.  If this is a REMOVED_MONGO_USER navigation, then just use
  // the raw basename which allows the basename to have full control over the
  // presence of a trailing slash on REMOVED_MONGO_USER actions
  if (basename !== "/") {
